...
const Banner = () => {
  ...
  <div className="container mw-1680">
    <div className="banner-content-three" data-cues="slideInUp" data-group="images">
      <h1>DIGITAL</h1>
      <h1 className="agency">AGENCY</h1>
      <div className="agency-info">
        <p>Hi 👋. We are Stir A brand-driven Digital agency that infuses authenticity into everything we do.</p>
  ...
  <img src="assets/images/banner-img-three.jpg" className="banner-img-three" alt="banner-img" />
  <img src="assets/images/shape-4.png" className="shape shape-4" alt="shape" />
