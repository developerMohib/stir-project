            ...
            >
              <div className="accordion-body">
                <p>
                  ...
                  communication, meticulous attention to detail, and a passion
            ...
            <h2 className="accordion-header">
              ...
              >
                <span className="d-sm-flex align-items-center">
                  ...
                  <span className="flex-grow-1 mt-3 mt-sm-0">
                    <span>
                      What is the difference between media and creative agency?
                    </span>
                  </span>
                </span>
              </button>
            ...
            <h2 className="accordion-header">
              ...
              >
                <span className="d-sm-flex align-items-center">
                  ...
                  <span className="flex-grow-1 mt-3 mt-sm-0">
                    <span>
                      Who is responsible for the creative product of an agency?
                    </span>
                  </span>
                </span>
              </button>
